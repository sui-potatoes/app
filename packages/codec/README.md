...
- `codec::hex` - implements Base16 or HEX
- `codec::base64` - implements Base64
- `codec::urlencode` - implements URL encoding
- `codec::potatoes` - implements the POTATOES encoding scheme

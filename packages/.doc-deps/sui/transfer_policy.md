...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_confirm_request">confirm_request</a>&lt;T&gt;(
    ...
    <b>assert</b>!(total == self.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>.size(), <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_EPolicyNotSatisfied">EPolicyNotSatisfied</a>);
    <b>while</b> (total &gt; 0) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_add_rule">add_rule</a>&lt;T, Rule: drop, Config: store + drop&gt;(
    ...
    policy.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>.insert(type_name::get&lt;Rule&gt;())
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_remove_rule">remove_rule</a>&lt;T, Rule: drop, Config: store + drop&gt;(
    ...
    policy.<a href="../../dependencies/sui/transfer_policy.md#sui_transfer_policy_rules">rules</a>.remove(&type_name::get&lt;Rule&gt;());
}
</code></pre>

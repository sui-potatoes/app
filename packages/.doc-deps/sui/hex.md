...
<pre><code><b>const</b> <a href="../../dependencies/sui/hex.md#sui_hex_EInvalidHexLength">EInvalidHexLength</a>: u64 = 0;
</code></pre>
...
<pre><code><b>const</b> <a href="../../dependencies/sui/hex.md#sui_hex_ENotValidHexCharacter">ENotValidHexCharacter</a>: u64 = 1;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/hex.md#sui_hex_encode">encode</a>(bytes: vector&lt;u8&gt;): vector&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/hex.md#sui_hex_encode">encode</a>(bytes: vector&lt;u8&gt;): vector&lt;u8&gt; {
    ...
    <b>let</b> hex_vector = <a href="../../dependencies/sui/hex.md#sui_hex_HEX">HEX</a>;
    <b>while</b> (i &lt; l) {
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/hex.md#sui_hex_decode">decode</a>(hex: vector&lt;u8&gt;): vector&lt;u8&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../../dependencies/sui/hex.md#sui_hex_decode">decode</a>(hex: vector&lt;u8&gt;): vector&lt;u8&gt; {
    ...
    <b>assert</b>!(l % 2 == 0, <a href="../../dependencies/sui/hex.md#sui_hex_EInvalidHexLength">EInvalidHexLength</a>);
    <b>while</b> (i &lt; l) {
        <b>let</b> decimal = <a href="../../dependencies/sui/hex.md#sui_hex_decode_byte">decode_byte</a>(hex[i]) * 16 + <a href="../../dependencies/sui/hex.md#sui_hex_decode_byte">decode_byte</a>(hex[i + 1]);
        r.push_back(decimal);
        i = i + 2;
    };
    r
...
<pre><code><b>fun</b> <a href="../../dependencies/sui/hex.md#sui_hex_decode_byte">decode_byte</a>(hex: u8): u8
</code></pre>
...
<pre><code><b>fun</b> <a href="../../dependencies/sui/hex.md#sui_hex_decode_byte">decode_byte</a>(hex: u8): u8 {
    <b>if</b> (48 &lt;= hex && hex &lt; 58) {
        ...
        <b>abort</b> <a href="../../dependencies/sui/hex.md#sui_hex_ENotValidHexCharacter">ENotValidHexCharacter</a>
    }
}
</code></pre>

...
<dt>
<code>storage_fund: <a href="../sui_system/storage_fund.md#sui_system_storage_fund_StorageFund">sui_system::storage_fund::StorageFund</a></code>
</dt>
<dd>
 The storage fund.
</dd>
...
<dt>
<code>stake_subsidy: <a href="../sui_system/stake_subsidy.md#sui_system_stake_subsidy_StakeSubsidy">sui_system::stake_subsidy::StakeSubsidy</a></code>
</dt>
<dd>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../sui_system/sui_system_state_inner.md#sui_system_sui_system_state_inner_request_add_validator_candidate">request_add_validator_candidate</a>(
    ...
    self.validators.<a href="../sui_system/sui_system_state_inner.md#sui_system_sui_system_state_inner_request_add_validator_candidate">request_add_validator_candidate</a>(validator, ctx);
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../sui_system/sui_system_state_inner.md#sui_system_sui_system_state_inner_request_set_gas_price">request_set_gas_price</a>(
    ...
    validator.<a href="../sui_system/sui_system_state_inner.md#sui_system_sui_system_state_inner_request_set_gas_price">request_set_gas_price</a>(verified_cap, new_gas_price);
}
</code></pre>
    ...
    <b>if</b> (
        ...
        <b>if</b> (self.stake_subsidy.get_distribution_counter() == 540 && old_epoch &gt; 560) {
            ...
            safe_mode_epoch_count.do!(|_| {
                stake_subsidy.join(self.stake_subsidy.<a href="../sui_system/sui_system_state_inner.md#sui_system_sui_system_state_inner_advance_epoch">advance_epoch</a>());
            });

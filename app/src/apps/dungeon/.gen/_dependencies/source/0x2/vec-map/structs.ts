...
export function isEntry(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::vec_map::Entry` + '<'); }
...
export class Entry<K extends TypeArgument, V extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::vec_map::Entry`; static readonly $numTypeParams = 2;
...
export function isVecMap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::vec_map::VecMap` + '<'); }
...
export class VecMap<K extends TypeArgument, V extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::vec_map::VecMap`; static readonly $numTypeParams = 2;

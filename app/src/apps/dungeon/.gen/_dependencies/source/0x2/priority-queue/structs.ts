...
export function isEntry(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::priority_queue::Entry` + '<'); }
...
export class Entry<T extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::priority_queue::Entry`; static readonly $numTypeParams = 1;
...
export function isPriorityQueue(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::priority_queue::PriorityQueue` + '<'); }
...
export class PriorityQueue<T extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::priority_queue::PriorityQueue`; static readonly $numTypeParams = 1;

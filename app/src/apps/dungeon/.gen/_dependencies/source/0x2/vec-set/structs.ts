...
export function isVecSet(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::vec_set::VecSet` + '<'); }
...
export class VecSet<K extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::vec_set::VecSet`; static readonly $numTypeParams = 1;

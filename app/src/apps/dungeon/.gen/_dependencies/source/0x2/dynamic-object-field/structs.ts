...
export function isWrapper(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::dynamic_object_field::Wrapper` + '<'); }
...
export class Wrapper<Name extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::dynamic_object_field::Wrapper`; static readonly $numTypeParams = 1;

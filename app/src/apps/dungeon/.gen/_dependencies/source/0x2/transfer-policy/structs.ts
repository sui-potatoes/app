...
export function isRuleKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::transfer_policy::RuleKey` + '<'); }
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::transfer_policy::RuleKey`; static readonly $numTypeParams = 1;
...
export function isTransferPolicy(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::transfer_policy::TransferPolicy` + '<'); }
...
export class TransferPolicy<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::transfer_policy::TransferPolicy`; static readonly $numTypeParams = 1;
...
export function isTransferPolicyCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::transfer_policy::TransferPolicyCap` + '<'); }
...
export class TransferPolicyCap<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::transfer_policy::TransferPolicyCap`; static readonly $numTypeParams = 1;
...
export function isTransferPolicyCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::transfer_policy::TransferPolicyCreated` + '<'); }
...
export class TransferPolicyCreated<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::transfer_policy::TransferPolicyCreated`; static readonly $numTypeParams = 1;
...
export function isTransferPolicyDestroyed(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::transfer_policy::TransferPolicyDestroyed` + '<'); }
...
export class TransferPolicyDestroyed<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::transfer_policy::TransferPolicyDestroyed`; static readonly $numTypeParams = 1;
...
export function isTransferRequest(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::transfer_policy::TransferRequest` + '<'); }
...
export class TransferRequest<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::transfer_policy::TransferRequest`; static readonly $numTypeParams = 1;

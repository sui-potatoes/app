...
export function isG1(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::bls12381::G1`; }

export interface G1Fields { dummyField: ToField<"bool"> }

export type G1Reified = Reified< G1, G1Fields >;

export class G1 implements StructClass { static readonly $typeName = `${PKG_V19}::bls12381::G1`; static readonly $numTypeParams = 0;
...
export function isG2(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::bls12381::G2`; }

export interface G2Fields { dummyField: ToField<"bool"> }

export type G2Reified = Reified< G2, G2Fields >;

export class G2 implements StructClass { static readonly $typeName = `${PKG_V19}::bls12381::G2`; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: G2Fields, ) { this.$fullTypeName = composeSuiType( G2.$typeName, ...typeArgs ) as `${typeof PKG_V19}::bls12381::G2`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): G2Reified { return { typeName: G2.$typeName, fullTypeName: composeSuiType( G2.$typeName, ...[] ) as `${typeof PKG_V19}::bls12381::G2`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => G2.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => G2.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => G2.fromBcs( data, ), bcs: G2.bcs, fromJSONField: (field: any) => G2.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => G2.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => G2.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => G2.fetch( client, id, ), new: ( fields: G2Fields, ) => { return new G2( [], fields ) }, kind: "StructClassReified", } }
...
export function isGT(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::bls12381::GT`; }

export interface GTFields { dummyField: ToField<"bool"> }

export type GTReified = Reified< GT, GTFields >;

export class GT implements StructClass { static readonly $typeName = `${PKG_V19}::bls12381::GT`; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: GTFields, ) { this.$fullTypeName = composeSuiType( GT.$typeName, ...typeArgs ) as `${typeof PKG_V19}::bls12381::GT`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): GTReified { return { typeName: GT.$typeName, fullTypeName: composeSuiType( GT.$typeName, ...[] ) as `${typeof PKG_V19}::bls12381::GT`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => GT.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => GT.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => GT.fromBcs( data, ), bcs: GT.bcs, fromJSONField: (field: any) => GT.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => GT.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => GT.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => GT.fetch( client, id, ), new: ( fields: GTFields, ) => { return new GT( [], fields ) }, kind: "StructClassReified", } }
...
export function isScalar(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::bls12381::Scalar`; }

export interface ScalarFields { dummyField: ToField<"bool"> }

export type ScalarReified = Reified< Scalar, ScalarFields >;

export class Scalar implements StructClass { static readonly $typeName = `${PKG_V19}::bls12381::Scalar`; static readonly $numTypeParams = 0;

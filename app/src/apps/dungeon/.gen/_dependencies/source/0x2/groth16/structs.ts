...
export function isCurve(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::groth16::Curve`; }

export interface CurveFields { id: ToField<"u8"> }

export type CurveReified = Reified< Curve, CurveFields >;

export class Curve implements StructClass { static readonly $typeName = `${PKG_V19}::groth16::Curve`; static readonly $numTypeParams = 0;
...
export function isPreparedVerifyingKey(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::groth16::PreparedVerifyingKey`; }
...
export class PreparedVerifyingKey implements StructClass { static readonly $typeName = `${PKG_V19}::groth16::PreparedVerifyingKey`; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: PreparedVerifyingKeyFields, ) { this.$fullTypeName = composeSuiType( PreparedVerifyingKey.$typeName, ...typeArgs ) as `${typeof PKG_V19}::groth16::PreparedVerifyingKey`; this.$typeArgs = typeArgs;
...
export function isProofPoints(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::groth16::ProofPoints`; }
...
export class ProofPoints implements StructClass { static readonly $typeName = `${PKG_V19}::groth16::ProofPoints`; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: ProofPointsFields, ) { this.$fullTypeName = composeSuiType( ProofPoints.$typeName, ...typeArgs ) as `${typeof PKG_V19}::groth16::ProofPoints`; this.$typeArgs = typeArgs;

 this.bytes = fields.bytes; }

 static reified( ): ProofPointsReified { return { typeName: ProofPoints.$typeName, fullTypeName: composeSuiType( ProofPoints.$typeName, ...[] ) as `${typeof PKG_V19}::groth16::ProofPoints`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ProofPoints.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ProofPoints.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ProofPoints.fromBcs( data, ), bcs: ProofPoints.bcs, fromJSONField: (field: any) => ProofPoints.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ProofPoints.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ProofPoints.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => ProofPoints.fetch( client, id, ), new: ( fields: ProofPointsFields, ) => { return new ProofPoints( [], fields ) }, kind: "StructClassReified", } }
...
export function isPublicProofInputs(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::groth16::PublicProofInputs`; }
...
export class PublicProofInputs implements StructClass { static readonly $typeName = `${PKG_V19}::groth16::PublicProofInputs`; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: PublicProofInputsFields, ) { this.$fullTypeName = composeSuiType( PublicProofInputs.$typeName, ...typeArgs ) as `${typeof PKG_V19}::groth16::PublicProofInputs`; this.$typeArgs = typeArgs;

 this.bytes = fields.bytes; }

 static reified( ): PublicProofInputsReified { return { typeName: PublicProofInputs.$typeName, fullTypeName: composeSuiType( PublicProofInputs.$typeName, ...[] ) as `${typeof PKG_V19}::groth16::PublicProofInputs`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => PublicProofInputs.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PublicProofInputs.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => PublicProofInputs.fromBcs( data, ), bcs: PublicProofInputs.bcs, fromJSONField: (field: any) => PublicProofInputs.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => PublicProofInputs.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => PublicProofInputs.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => PublicProofInputs.fetch( client, id, ), new: ( fields: PublicProofInputsFields, ) => { return new PublicProofInputs( [], fields ) }, kind: "StructClassReified", } }

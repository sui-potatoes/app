...
export function isRuleKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::token::RuleKey` + '<'); }
...
export class RuleKey<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::token::RuleKey`; static readonly $numTypeParams = 1;
...
export function isActionRequest(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::token::ActionRequest` + '<'); }
...
export class ActionRequest<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::token::ActionRequest`; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: ActionRequestFields<T>, ) { this.$fullTypeName = composeSuiType( ActionRequest.$typeName, ...typeArgs ) as `${typeof PKG_V19}::token::ActionRequest<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export function isToken(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::token::Token` + '<'); }
...
export class Token<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::token::Token`; static readonly $numTypeParams = 1;
...
export function isTokenPolicy(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::token::TokenPolicy` + '<'); }
...
export class TokenPolicy<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::token::TokenPolicy`; static readonly $numTypeParams = 1;
...
export function isTokenPolicyCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::token::TokenPolicyCap` + '<'); }
...
export class TokenPolicyCap<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::token::TokenPolicyCap`; static readonly $numTypeParams = 1;
...
export function isTokenPolicyCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::token::TokenPolicyCreated` + '<'); }
...
export class TokenPolicyCreated<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::token::TokenPolicyCreated`; static readonly $numTypeParams = 1;

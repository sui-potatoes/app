...
export function isLinkedTable(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::linked_table::LinkedTable` + '<'); }
...
export class LinkedTable<K extends TypeArgument, V extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::linked_table::LinkedTable`; static readonly $numTypeParams = 2;
...
export function isNode(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::linked_table::Node` + '<'); }
...
export class Node<K extends TypeArgument, V extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::linked_table::Node`; static readonly $numTypeParams = 2;

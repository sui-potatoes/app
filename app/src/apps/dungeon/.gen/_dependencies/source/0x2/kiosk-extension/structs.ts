...
export function isExtension(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::kiosk_extension::Extension`; }
...
export class Extension implements StructClass { static readonly $typeName = `${PKG_V19}::kiosk_extension::Extension`; static readonly $numTypeParams = 0;
...
export function isExtensionKey(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::kiosk_extension::ExtensionKey` + '<'); }
...
export class ExtensionKey<Ext extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::kiosk_extension::ExtensionKey`; static readonly $numTypeParams = 1;

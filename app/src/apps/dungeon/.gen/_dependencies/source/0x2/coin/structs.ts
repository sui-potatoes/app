...
export function isCoin(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::coin::Coin` + '<'); }
...
export class Coin<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::coin::Coin`; static readonly $numTypeParams = 1;
...
export function isCoinMetadata(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::coin::CoinMetadata` + '<'); }
...
export class CoinMetadata<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::coin::CoinMetadata`; static readonly $numTypeParams = 1;
 ...
 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: CoinMetadataFields<T>, ) { this.$fullTypeName = composeSuiType( CoinMetadata.$typeName, ...typeArgs ) as `${typeof PKG_V19}::coin::CoinMetadata<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;
...
export function isCurrencyCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::coin::CurrencyCreated` + '<'); }
...
export class CurrencyCreated<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::coin::CurrencyCreated`; static readonly $numTypeParams = 1;
...
export function isDenyCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::coin::DenyCap` + '<'); }
...
export class DenyCap<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::coin::DenyCap`; static readonly $numTypeParams = 1;
...
export function isRegulatedCoinMetadata(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::coin::RegulatedCoinMetadata` + '<'); }
...
export class RegulatedCoinMetadata<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::coin::RegulatedCoinMetadata`; static readonly $numTypeParams = 1;
...
export function isTreasuryCap(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::coin::TreasuryCap` + '<'); }
...
export class TreasuryCap<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::coin::TreasuryCap`; static readonly $numTypeParams = 1;

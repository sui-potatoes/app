...
export function isDisplay(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::display::Display` + '<'); }
...
export class Display<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::display::Display`; static readonly $numTypeParams = 1;
...
export function isDisplayCreated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::display::DisplayCreated` + '<'); }
...
export class DisplayCreated<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::display::DisplayCreated`; static readonly $numTypeParams = 1;
...
export function isVersionUpdated(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::display::VersionUpdated` + '<'); }
...
export class VersionUpdated<T extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::display::VersionUpdated`; static readonly $numTypeParams = 1;

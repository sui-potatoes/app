...
export function isPublisher(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::package::Publisher`; }
...
export class Publisher implements StructClass { static readonly $typeName = `${PKG_V19}::package::Publisher`; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: PublisherFields, ) { this.$fullTypeName = composeSuiType( Publisher.$typeName, ...typeArgs ) as `${typeof PKG_V19}::package::Publisher`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.package = fields.package;; this.moduleName = fields.moduleName; }

 static reified( ): PublisherReified { return { typeName: Publisher.$typeName, fullTypeName: composeSuiType( Publisher.$typeName, ...[] ) as `${typeof PKG_V19}::package::Publisher`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => Publisher.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Publisher.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => Publisher.fromBcs( data, ), bcs: Publisher.bcs, fromJSONField: (field: any) => Publisher.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => Publisher.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => Publisher.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => Publisher.fetch( client, id, ), new: ( fields: PublisherFields, ) => { return new Publisher( [], fields ) }, kind: "StructClassReified", } }
...
export function isUpgradeCap(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::package::UpgradeCap`; }
...
export class UpgradeCap implements StructClass { static readonly $typeName = `${PKG_V19}::package::UpgradeCap`; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: UpgradeCapFields, ) { this.$fullTypeName = composeSuiType( UpgradeCap.$typeName, ...typeArgs ) as `${typeof PKG_V19}::package::UpgradeCap`; this.$typeArgs = typeArgs;

 this.id = fields.id;; this.package = fields.package;; this.version = fields.version;; this.policy = fields.policy; }

 static reified( ): UpgradeCapReified { return { typeName: UpgradeCap.$typeName, fullTypeName: composeSuiType( UpgradeCap.$typeName, ...[] ) as `${typeof PKG_V19}::package::UpgradeCap`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpgradeCap.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpgradeCap.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpgradeCap.fromBcs( data, ), bcs: UpgradeCap.bcs, fromJSONField: (field: any) => UpgradeCap.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpgradeCap.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpgradeCap.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => UpgradeCap.fetch( client, id, ), new: ( fields: UpgradeCapFields, ) => { return new UpgradeCap( [], fields ) }, kind: "StructClassReified", } }
...
export function isUpgradeReceipt(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::package::UpgradeReceipt`; }
...
export class UpgradeReceipt implements StructClass { static readonly $typeName = `${PKG_V19}::package::UpgradeReceipt`; static readonly $numTypeParams = 0;
...
export function isUpgradeTicket(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V19}::package::UpgradeTicket`; }
...
export class UpgradeTicket implements StructClass { static readonly $typeName = `${PKG_V19}::package::UpgradeTicket`; static readonly $numTypeParams = 0;
 ...
 private constructor(typeArgs: [], fields: UpgradeTicketFields, ) { this.$fullTypeName = composeSuiType( UpgradeTicket.$typeName, ...typeArgs ) as `${typeof PKG_V19}::package::UpgradeTicket`; this.$typeArgs = typeArgs;

 this.cap = fields.cap;; this.package = fields.package;; this.policy = fields.policy;; this.digest = fields.digest; }

 static reified( ): UpgradeTicketReified { return { typeName: UpgradeTicket.$typeName, fullTypeName: composeSuiType( UpgradeTicket.$typeName, ...[] ) as `${typeof PKG_V19}::package::UpgradeTicket`, typeArgs: [ ] as [], reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UpgradeTicket.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UpgradeTicket.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UpgradeTicket.fromBcs( data, ), bcs: UpgradeTicket.bcs, fromJSONField: (field: any) => UpgradeTicket.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UpgradeTicket.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UpgradeTicket.fromSuiParsedData( content, ), fetch: async (client: SuiClient, id: string) => UpgradeTicket.fetch( client, id, ), new: ( fields: UpgradeTicketFields, ) => { return new UpgradeTicket( [], fields ) }, kind: "StructClassReified", } }

...
export function isField(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::dynamic_field::Field` + '<'); }
...
export class Field<Name extends TypeArgument, Value extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::dynamic_field::Field`; static readonly $numTypeParams = 2;

...
export function isObjectTable(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V19}::object_table::ObjectTable` + '<'); }
...
export class ObjectTable<K extends PhantomTypeArgument, V extends PhantomTypeArgument> implements StructClass { static readonly $typeName = `${PKG_V19}::object_table::ObjectTable`; static readonly $numTypeParams = 2;

...
export function isFixedPoint32(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V6}::fixed_point32::FixedPoint32`; }
...
export class FixedPoint32 implements StructClass { static readonly $typeName = `${PKG_V6}::fixed_point32::FixedPoint32`; static readonly $numTypeParams = 0;

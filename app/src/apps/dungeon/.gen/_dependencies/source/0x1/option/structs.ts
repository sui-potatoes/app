...
export function isOption(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V6}::option::Option` + '<'); }
...
export class Option<Element extends TypeArgument> implements StructClass { static readonly $typeName = `${PKG_V6}::option::Option`; static readonly $numTypeParams = 1;
